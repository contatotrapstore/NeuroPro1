...
/**
 * API para gerenciar assistentes de uma instituição específica
 * Rota: /api/admin/institutions/[id]/assistants
 */
module.exports = async function handler(req, res) {
  console.log('🏛️🤖 Institution Assistants API v1.0');
  ...
  try {
    ...
    // Get institution ID from query parameter
    ...
    console.error('Institution Assistants API Error:', error);
    return res.status(500).json({
      success: false,
